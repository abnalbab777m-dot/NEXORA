...
export default function AdminTasks() {
  ...
  const [activeTab, setActiveTab] = useState<'TASKS' | 'COMPLETIONS'>('TASKS');
                      ...
                      <tr key={compId} className="hover:bg-neutral-900/50 transition-colors">
                        ...
                        <td className="px-5 py-4">
                          <div className="flex items-center gap-2">
                            ...
                            {comp.proofImage && (
                              <button
                                onClick={() => setReviewingCompletion(comp)}
        ...
        <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
          <Card className="w-full max-w-lg border-neutral-800 bg-neutral-900 shadow-2xl animate-in fade-in zoom-in-95">
            ...
            <CardContent className="pt-5 space-y-4">
              ...
              {/* Proof Image */}
              {reviewingCompletion.proofImage && (
                <div>
                  <label className="block text-xs font-semibold text-neutral-300 mb-1.5">
                    صورة لقطة الشاشة المرسلة من العضو:
                  </label>
                  <div className="rounded-xl border border-neutral-800 overflow-hidden bg-black p-2 flex justify-center">
                    <img 
                      src={reviewingCompletion.proofImage} 
